...
let url = "https://tjallingvana-5000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai";
...
public_users.get('/books/isbn/:isbn', function (req, res) {
    ...
    async function getBooks() {
        let firstPromise = new Promise(async function (resolve) {
    ...
    async function filterBooks() {
        let twoPromise = new Promise(async function (resolve, reject) {
